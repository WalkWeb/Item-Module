...
class DrawingFactoryTest extends TestCase
{
    ...
    public function testDrawingFactoryCreateSuccess(array $data): void
    {
        ...
        self::assertEquals($data['min_strength'], $drawing->getMinStrength());
        self::assertEquals($data['min_dexterity'], $drawing->getMinDexterity());
        self::assertEquals($data['min_intelligence'], $drawing->getMinIntelligence());
    ...
    public function failDataProvider(): array
    {
        return [
            ...
            [
                ...
                DrawingException::INVALID_MIN_STRENGTH,
            ],
            // min_strength invalid type
            [
                [
                    'id'               => 143,
                    'name'             => 'Sword',
            ...
            [
                ...
                DrawingException::INVALID_MIN_DEXTERITY,
            ],
            // min_dexterity invalid type
            [
                [
                    'id'               => 143,
                    'name'             => 'Sword',
            ...
            [
                ...
                DrawingException::INVALID_MIN_INTELLIGENCE,
            ],
            // min_intelligence invalid type
            [
                [
                    'id'               => 143,
                    'name'             => 'Sword',
